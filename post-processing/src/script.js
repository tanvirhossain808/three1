...
//Gama collection pass
const gamaCollectionPass = new ShaderPass(GammaCorrectionShader)
effectComposer.addPass(gamaCollectionPass)
const unreamBloomPass = new UnrealBloomPass()
effectComposer.addPass(unreamBloomPass)
unreamBloomPass.strength = 0.3
unreamBloomPass.radius = 1
unreamBloomPass.threshold = 0.6

gui.add(unreamBloomPass, "enabled")
